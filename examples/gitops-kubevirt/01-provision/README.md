...
1. Open ArgoCD console (get URL from setup output)
...
- [Documentation: Provisioning Deep-Dive](../../docs/gitops/03-provisioning.md)
- [Documentation: Architecture](../../docs/gitops/01-architecture.md)

## Troubleshooting

See [VALIDATION.md](VALIDATION.md) for validation steps and [../../docs/gitops/07-troubleshooting.md](../../docs/gitops/07-troubleshooting.md) for common issues.
