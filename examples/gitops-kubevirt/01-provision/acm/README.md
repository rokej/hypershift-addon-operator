...
Key points:
- Contains critical annotations (`klusterlet-deploy-mode: "Hosted"`, `createdVia: "hypershift"`)
- Labels indicate auto-import (`vendor: auto`, `cloud: auto`)
...
See [../../docs/gitops/08-troubleshooting.md](../../../docs/gitops/08-troubleshooting.md) for detailed troubleshooting steps.

## Learn More

- [04-acm-integration-overview.md](../../../docs/gitops/04-acm-integration-overview.md) - High-level ACM integration
- [05-auto-import-deep-dive.md](../../../docs/gitops/05-auto-import-deep-dive.md) - Detailed auto-import process
