...
- [ ] Setup scripts completed successfully (`verify-setup.sh` passes)
- [ ] Secrets created in `clusters` namespace
- [ ] Argo CD console accessible
...
- [ ] **Watch HostedCluster status:**
  ...
  ```
  Wait for: VERSION shows 4.17.0, AVAILABLE becomes True (~10-15 minutes)
...
- [../../docs/gitops/07-troubleshooting.md](../../docs/gitops/07-troubleshooting.md)
- [../../docs/gitops/03-provisioning.md](../../docs/gitops/03-provisioning.md)
